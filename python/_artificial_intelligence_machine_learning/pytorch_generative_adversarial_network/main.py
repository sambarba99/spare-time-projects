...
from _utils.plotting import plot_torch_model, plot_image_array
...
if __name__ == '__main__':
	...
	if os.path.exists('./gen_model.pth'):
		...
		plot_image_array(
			fake_images_test, rows=4, cols=6, gap=4, scale_factor=1.5,
	...
	# 	plot_image_array(
	# 		latent_space_test, rows=4, cols=6, gap=4, scale_factor=1.5,
	# 		background_rgb=(0, 0, 0), title_rgb=(255, 255, 255),
