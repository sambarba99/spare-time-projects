...
def updated_dict(arg_dict: dict[str, Any], update_key: str, update_value: Any) -> dict[str, Any]:
	return {
...
def assert_input_type(func_name: str, valid_input_types: tuple[type, ...], in_var: Any) -> None:
