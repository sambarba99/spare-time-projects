...
class DiffusionController:
	def __init__(self, *, num_timesteps, beta_min, beta_max, device):
		"""
		Betas represent the noise variance added at each diffusion step.
		Alphas represent the fraction of original image information that
		remains after each diffusion step.
		"""
