...
if __name__ == '__main__':
	...
	root.config(width=600, height=660, background='#202029')
	root.eval('tk::PlaceWindow . center')
	root.resizable(False, False)

	lbl_selected_path = tk.Label(root, text='Selected path: None', font='consolas', background='#202029', foreground='white')
	...
	discovered_files_lbl = tk.Label(root, text='Discovered files:', font='consolas', background='#202029', foreground='white')
