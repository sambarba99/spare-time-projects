...
def main():
	...
	with torch.inference_mode():
		...
		test_f1 = f1_score(y_test.argmax(dim=1), y_test_pred, average='weighted')

		print('Test loss:', test_loss.item())
		print('Test F1 score:', test_f1)

		test_conf_mat = confusion_matrix(y_test_pred, y_test.argmax(dim=1))  # Decode from one-hot
		plot_confusion_matrix(test_conf_mat, test_f1)
