...
SINGLE_NUM_WITHIN_PAREN = r'open+(num)closed+' \
	.replace('num', NUMBER_REG) \
	.replace('open', OPEN_PAREN_REG) \
	.replace('closed', CLOSED_PAREN_REG)
...
if __name__ == '__main__':
	...
	rpn_result_lbl = tk.Label(root, text='In RPN:', font='consolas', bg='#000024', fg='white')
	output_rpn = tk.Label(root, font='consolas', bg='white')
	evaluation_lbl = tk.Label(root, text='Evaluation:', font='consolas', bg='#000024', fg='white')
