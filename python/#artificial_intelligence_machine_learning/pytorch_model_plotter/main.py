...
def load_model_from_py(file_path, model_class_name, *args, **kwargs):
...
if __name__ == '__main__':
	...
	plot_model(model, (4,), './model_architecture_sequential')

	model = load_model_from_py('C:/Users/Sam/Desktop/Projects/python/#artificial_intelligence_machine_learning/pytorch_mnist/conv_net.py', 'CNN')
	plot_model(model, (1, 28, 28), './model_architecture_custom_class')

	# nodes = [
	# 	{'layer_name': 'conv_block', 'layer_type': 'Conv2d', 'output_shape': (32, 26, 26), 'activation': 'LeakyReLU'},
	# 	{'layer_name': 'conv_block', 'layer_type': 'MaxPool2d', 'output_shape': (32, 13, 13)},
	# 	{'layer_name': 'conv_block', 'layer_type': 'Conv2d', 'output_shape': (64, 11, 11), 'activation': 'LeakyReLU'},
	# 	{'layer_name': 'conv_block', 'layer_type': 'MaxPool2d', 'output_shape': (64, 5, 5)},
	# 	{'layer_name': 'fc_block', 'layer_type': 'Flatten', 'output_shape': (1600,)},
	# 	{'layer_name': 'fc_block', 'layer_type': 'Dropout', 'output_shape': (1600,)},
	# 	{'layer_name': 'fc_block', 'layer_type': 'Linear', 'output_shape': (128,), 'activation': 'LeakyReLU'},
	# 	{'layer_name': 'fc_block', 'layer_type': 'Linear', 'output_shape': (10,), 'activation': 'Softmax'}
	# ]
	# edges = [(i, i + 1) for i in range(len(nodes) - 1)]

	# plot_model_manual(nodes, edges, (1, 28, 28))
