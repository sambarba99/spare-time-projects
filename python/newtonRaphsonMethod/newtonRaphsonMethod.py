...
if __name__ == "__main__":
	...
	btn_find_root = tk.Button(frame, text="Find root", font="consolas",
		command=lambda: handle_button_click(entry_box.get(), True))
	btn_find_stat_point = tk.Button(frame, text="Find stationary point", font="consolas",
